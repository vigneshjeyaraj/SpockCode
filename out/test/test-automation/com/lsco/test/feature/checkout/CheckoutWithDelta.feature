#SPRING-17584
Feature: Checkout With Delta

@Transactional_LE_GB_en_GB @Transactional_DS_GB_en_GB
@Regression_LE_GB_en_GB @Regression_DS_GB_en_GB
Scenario: Checkout With Delta
Given an guest user
...
And choose Delta credit card
And enter the credit card number "4310720000000091", the security code "111", the expiration month "01" and expiration year "16"
